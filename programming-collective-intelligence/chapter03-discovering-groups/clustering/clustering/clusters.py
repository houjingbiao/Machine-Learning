...
def hcluster(rows, distance=pearson):
    ...
    while(len(clust)>1):
        #travese to find the pair with the smallest dist
        closest = 2
        lowestpair=(0, 0)
...
def drawnode(draw, clust, x, y, scaling, labels):
    if clust.id < 0:
        ...
        #horizonal line: to left node
        draw.line((x, top+h1/2, x+l1, top+h1/2), fill=(255, 0, 0))
        #horizonal line: to right node
